...
<table style="width:100%">
    ...
    <td> <button type='submit' value=".$dizi["Picture"]." name='use_button' ' ><img width='50px' height='50px' src='https://purepng.com/public/uploads/large/purepng.com-shopping-basketshoppingcarttrolleycarriagebuggysupermarketsbasket-1421526532727qjew3.png'  ></button></td>
	</form>
  </tr>";
