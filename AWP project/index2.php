...
<tr class="active">
	<td name="code"><?php echo $data['productCode']; ?></td>
	<td name="name"><?php echo $data['productName']; ?></td>
	<td name="line"><?php echo $data['productLine']; ?></td>
	<td><?php echo $data['productScale']; ?></td>
	<td><?php echo $data['productVendor']; ?></td>
	<td><?php echo $data['productDescription']; ?></td>
	<td><?php echo $data['quantityInStock']; ?></td>
	<td name="price"><?php echo $data['buyPrice']; ?></td>
	<td><?php echo $data['MSRP']; ?></td>
  <td><a href="basket1.php?action=ajout&amp;l=<?php echo $data['productCode']; ?>&amp;q=1&amp;p=<?php echo $data['buyPrice']; ?>" onclick="window.location.href(this.href, '', 
'toolbar=no, location=no, directories=no, status=yes, scrollbars=yes, resizable=yes, copyhistory=no, width=600, height=350'); return false;">Add to basket</a></td>
</tr>
